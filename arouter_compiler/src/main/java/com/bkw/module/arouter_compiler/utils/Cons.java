package com.bkw.module.arouter_compiler.utils;

public class Cons {
    /**
     * 注解处理器支持的注解类型
     */
    public static final String AROUTER_ANNOTATION_TYPES = "com.bkw.module.arouter_annotation.ARouter";

    /**
     * 参数传递注解处理器
     */
    public static final String PARAMETER_ANNOTATION_TYPES = "com.bkw.module.arouter_annotation.Parameter";
     ...
     * 包名前缀封装
     */
    public static final String BASE_PACKAGE = "com.bkw.arouterapi";
    /**
     * 路由组Group加载接口
     */
