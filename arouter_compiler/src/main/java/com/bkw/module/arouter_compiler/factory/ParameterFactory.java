package com.bkw.module.arouter_compiler.factory;
...
public class ParameterFactory {
    ...
    private ParameterFactory(Builder builder) {
        ...
        methodBuidler = MethodSpec.methodBuilder(Cons.PARAMETER_METHOD_NAME)
                .addAnnotation(Override.class)
                .addModifiers(Modifier.PUBLIC)
                .addParameter(builder.parameterSpec);

        this.callMirror = builder.elementUtils
                .getTypeElement(Cons.CALL)
                .asType();
    ...
    public void buildStatement(Element element) {
        ...
        if (type == TypeKind.INT.ordinal()) {
            ...
            if (typeMirror.toString().equalsIgnoreCase(Constants.STRING)) {
                ...
                // 类型工具类方法isSubtype，相当于instanceof一样
                ...
                methodBuidler.addStatement(methodContent,
                        ...
                        ClassName.get(Cons.BASE_PACKAGE, Cons.ROUTER_MANAGER),
                        annotationValue);
                return;
            }
        }
